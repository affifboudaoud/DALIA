...
def create_model(theta_initial=None):
    """Create the 2-variate coregional spatio-temporal model."""
    ...
    # Coregional model combining both
    coreg_dict = {
        "type": "coregional",
        "n_models": 2,
...
if __name__ == "__main__":
    ...
    print_msg("--- Gaussian Coregional (2 variates) Spatio-Temporal Model ---\n")
    ...
    if args.benchmark_mode:
        ...
        run_benchmark(dalia_fd, dalia_jax, args, "gst_coreg2_small")
        exit(0)
