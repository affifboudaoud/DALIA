...
def create_model():
    """Create the Gaussian Coregional (3 variates) spatial model with regression."""
    nv = 3
    ns = 1092
    nt = 1
    nb = 3
...
if __name__ == "__main__":
    ...
    print_msg("--- Gaussian Coregional (3 variates) Spatial Model with Regression ---\n")
    ...
    if args.benchmark_mode:
        ...
        run_benchmark(dalia_fd, dalia_jax, args, "gs_coreg3_small")
        exit(0)
